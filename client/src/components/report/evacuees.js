...
function Evacuees() {
	...
	const handleAddMember = () => {
		...
		if (memberFirstName === "")
			errorValidation.push({ errorMsg: "Member First Name: Cannot be empty." });

		if (memberMiddleName === "")
			errorValidation.push({
				errorMsg: "Member Middle Name: Cannot be empty.",
			});

		if (memberLastName === "")
			errorValidation.push({ errorMsg: "Member Last Name: Cannot be empty." });

		/*if (memberBirthday === "" || memberBirthday === null)
			errorValidation.push({ errorMsg: "Birthday: Cannot be empty." });*/

		if (memberType === "")
			errorValidation.push({ errorMsg: "Member Type: Cannot be empty." });

		/*if (memberAge === "" || memberAge === null || memberAge === 0)
			errorValidation.push({ errorMsg: "Member Age: Cannot be empty." });*/

		if (memberGender === "" || memberGender === null)
			errorValidation.push({ errorMsg: "Member Gender: Cannot be empty." });

		if (memberPregnant === null)
			errorValidation.push({
				errorMsg: "Member Pregnant: Cannot be null  value.",
			});

		if (memberAddress === "")
			errorValidation.push({ errorMsg: "Member Address: Cannot be empty." });

		if (memberBarangay === "")
			errorValidation.push({ errorMsg: "Member Barangay: Cannot be empty." });

		if (memberMunicipality === "")
			errorValidation.push({
				errorMsg: "Member Municipality: Cannot be empty.",
			});

		if (memberContactNumber === "")
			errorValidation.push({
				errorMsg: "Member Contact No.: Cannot be empty.",
			});

		if (memberPwd === null)
			errorValidation.push({ errorMsg: "Member PWD: Cannot be null value." });
	...
	const evacueeList = evacueesData
		? evacueesData.map((x) => ({
				id: x._id,
					...
					<div className={classes.contentDiv}>
						...
						<div style={{ zIndex: 100 }}>
							...
							>
								<Button
									disableElevation
									style={{ backgroundColor: "#20aee3", color: "#fff" }}
								>
									Export to Excel
								</Button>
							</ButtonGroup>
						...
						<Paper className={classes.root}>
							<TableContainer component={Paper} className={classes.container}>
								...
								>
													...
													<StyledTableRow key={x.id}>
														...
														>
															...
															<Tooltip title="Delete">
																<IconButton
																	aria-label="delete"
																	onClick={() => handleOpenDelModal(x.id)}
																>
									...
									{evacueesLoading === true && <EvacueesLoading />}
								</Table>
							</TableContainer>
							<TablePagination
								style={{ color: "#fff" }}
						...
						<div className={classes.addModalPaper}>
										...
										<ThemeProvider>
											...
											<div style={{ width: "100%", marginBottom: 10 }}>
												...
												<TextField
													...
													variant="outlined"
													error={
														err !== null && middleName === "" ? true : false
													}
													helperText={
														err !== null && middleName === ""
											...
											{/* {
												<div style={{ width: "50%", marginRight: 10 }}>
													...
													<TextField
														...
														value={age}
														//onChange={(e) => setAge(Date.now() - birthday)}
													/>
												</div>
											} */}
										...
										<ThemeProvider>
											<div style={{ width: "100%", marginRight: 10 }}>
												...
												<TextField
													...
													variant="outlined"
													error={
														err !== null && municipality === "" ? true : false
													}
													helperText={
														err !== null && municipality === ""
											...
											<div style={{ width: "100%" }}>
												...
												<TextField
													...
													variant="outlined"
													error={
														err !== null && contactNumber === "" ? true : false
													}
													helperText={
														err !== null && contactNumber === ""
										...
										<ThemeProvider>
											<div>
												...
												<FormControlLabel
													...
													control={
														<IOSSwitch checked={pwd} onChange={handleBtnPwd} />
													}
													label=""
												/>
											</div>
							...
							<div style={{ width: "100%", marginTop: 20 }}>
								...
								<Paper className={classes.root}>
									<TableContainer
										component={Paper}
										className={classes.containerAddModal}
										style={{ marginTop: 10 }}
									>
										<Table
											className={classes.table}
													...
													<TableRow>
														...
														<StyledTableCell>
															<TextField
																...
																onChange={(e) =>
																	setMemberMiddleName(e.target.value)
																}
															/>
														</StyledTableCell>
														<StyledTableCell>
														...
														<StyledTableCell>
															<IOSSwitch
																...
																onChange={handleBtnMemberPregnant}
																name="checkedB"
															/>
														</StyledTableCell>
														<StyledTableCell>
														...
														<StyledTableCell>
															<TextField
																...
																onChange={(e) =>
																	setMemberBarangay(e.target.value)
																}
															/>
														</StyledTableCell>
														<StyledTableCell>
															<TextField
																value={memberMunicipality}
																onChange={(e) =>
																	setMemberMunicipality(e.target.value)
																}
															/>
														</StyledTableCell>
														<StyledTableCell>
											...
											<FormControlLabel
												...
												control={
													<IOSSwitch
														...
														checked={gender === "Male" ? false : pregnant}
														onChange={handleBtnPregnant}
														name="checkedB"
													/>
												}
...

			{
				...
				>
					<DialogTitle id="alert-dialog-title">
						{err !== null ? "Status: " + err.status : ""}
					</DialogTitle>
					<DialogContent>
						<DialogContentText
							id="alert-dialog-description"
							style={{ width: "50vh", maxWidth: "50vh" }}
						>
							{err !== null &&
								err.status === 400 &&
								err.error.map((x) => (
