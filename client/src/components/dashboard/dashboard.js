...
function Dashboard() {
	...
	useEffect(() => {
		...
		axios
			...
			.then(function (response) {
				...
				setTotalMale(
					data.filter((x) => x.gender === "male" || x.gender === "Male").length
				);
				setTotalFemale(
					data.filter((x) => x.gender === "female" || x.gender === "Female")
						.length
				);
	...
	let highRiskEvacueesChartConfig = {
		...
		series: [
			{
				text: "Elderly Pregnant: " + totalPregnant,
		...
		<div className={classes.mainDiv}>
			...
			<div>
				<div style={{ float: "left" }}>
					<Typography style={{ color: "#677574", marginTop: "5px" }}>
			...
			<Grid
				container
				spacing={window.innerWidth <= 558 ? 2 : 5}
							...
							<div style={{ margin: "0 auto", alignSelf: "center" }}>
								{window.innerWidth <= 558 ? (
									<div style={{ justifyContent: "center", display: "flex" }}>
										<FontAwesomeIcon
											icon={faUserInjured}
											style={{ color: "#ff9041", width: 50, height: 50 }}
										/>
									</div>
								) : (
									<div style={{ float: "left", marginRight: "10px" }}>
										<FontAwesomeIcon
											icon={faUserInjured}
											style={{ color: "#ff9041", width: 70, height: 70 }}
										/>
									</div>
								)}
								{window.innerWidth <= 558 ? (
							...
							<div style={{ margin: "0 auto", alignSelf: "center" }}>
								{window.innerWidth <= 558 ? (
									<div style={{ justifyContent: "center", display: "flex" }}>
										<FontAwesomeIcon
											icon={faMapMarkedAlt}
											style={{ color: "#6772e5", width: 50, height: 50 }}
										/>
									</div>
								) : (
									<div style={{ float: "left", marginRight: "10px" }}>
										<FontAwesomeIcon
											icon={faMapMarkedAlt}
											style={{ color: "#6772e5", width: 70, height: 70 }}
										/>
									</div>
								)}
								{window.innerWidth <= 558 ? (
							...
							<div style={{ margin: "0 auto", alignSelf: "center" }}>
								{window.innerWidth <= 558 ? (
									<div style={{ justifyContent: "center", display: "flex" }}>
										<FontAwesomeIcon
											icon={faSchool}
											style={{ color: "#24d2b5", width: 50, height: 50 }}
										/>
									</div>
								) : (
									<div style={{ float: "left", marginRight: "10px" }}>
										<FontAwesomeIcon
											icon={faSchool}
											style={{ color: "#24d2b5", width: 70, height: 70 }}
										/>
									</div>
								)}
								{window.innerWidth <= 558 ? (
								...
								{window.innerWidth <= 558 ? (
									<div style={{ justifyContent: "center", display: "flex" }}>
										<FontAwesomeIcon
											...
											style={{ color: "#ff5c6c", width: 50, height: 50 }}
										/>
									</div>
								) : (
									<div style={{ float: "left", marginRight: "10px" }}>
										<FontAwesomeIcon
											icon={faSkullCrossbones}
											style={{ color: "#ff5c6c", width: 70, height: 70 }}
										/>
									</div>
								)}
								{window.innerWidth <= 558 ? (
			...
			<Grid
				container
				spacing={window.innerWidth <= 558 ? 0 : 5}
				style={{ marginBottom: "20px" }}
			>
				<Grid
					item
					xs={window.innerWidth <= 558 ? 12 : 8}
					className={classes.breakdownGrid}
				>
				...
				<Grid
					item
					xs={window.innerWidth <= 558 ? 12 : 4}
					className={classes.breakdownGrid}
				>
					<Card
						className={classes.breakdownRightContentCard}
						style={{ marginBottom: "40px" }}
					>
						{/* <Typography variant='h6' style={{ color: '#fff' }}>Breakdown Per Gender</Typography> */}
						<ZingChart
							data={breakdownChartConfig}
							height="217px"
							width="100%"
						/>
					</Card>
					...
					<Card className={classes.breakdownRightContentCard}>
						...
						<div>
							...
							<ZingChart
								data={highRiskEvacueesChartConfig}
								height="214px"
								width="100%"
							/>
						</div>
